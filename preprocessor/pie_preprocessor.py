...
class PIEPreprocessor(Processor):
    def __init__(self, dataset_path, is_interactive, obs_frame_num, pred_frame_num, skip_frame_num,
        ...
        self.output_dir = os.path.join(PREPROCESSED_DATA_DIR, 'PIE')
        if self.is_interactive:
            self.output_dir = os.path.join(PREPROCESSED_DATA_DIR, 'PIE_interactive')
        elif self.save_total_frames:
            self.output_dir = os.path.join(PREPROCESSED_DATA_DIR, 'PIE_total')
