...
def parse_visualization_args():
    ...
    dataloader_args = DataloaderArgs(args.dataset_file, args.keypoint_dim, args.interactive, args.persons_num,
    ...
    return dataloader_args, model_args, args.load_path, args.ground_truth, args.pred_frames_num, args.index, args.images_dir, args.dataset_name
...
def __parse_visualization_args():
    ...
    # dataloader_args
    parser.add_argument('--dataset_file', type=str, help='name of the dataset file')
