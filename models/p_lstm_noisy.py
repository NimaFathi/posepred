...
class PLSTMNoisy(nn.Module):
    def __init__(self, args):
        super(PLSTMNoisy, self).__init__()
        self.args = args
        ...
        if self.args.use_dct:
            # observed_vel
            _, idct_obs_vel = get_dct_matrix(self.args.obs_frames_num - 1)
